namespace TurtleChallenge.Objects
{
    ...
    /// boolean as default. After the instantiation the list of Mines is traversed and the relevant boxes have the mine
    /// boolean set to true. Then exit <see cref="Coordinates"/> are used to set the Exit boolean to true. 
    /// </summary>
